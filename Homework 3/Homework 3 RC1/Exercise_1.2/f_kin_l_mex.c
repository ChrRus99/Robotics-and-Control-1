...
CASADI_SYMBOL_EXPORT int f_kin_l_work_bytes(casadi_int *sz_arg, casadi_int* sz_res, casadi_int *sz_iw, casadi_int *sz_w) {
...
casadi_int main_f_kin_l(casadi_int argc, char* argv[]) {
  ...
  flag = f_kin_l(arg, res, iw, w+16, 0);
  if (flag) return flag;
  r = w+4;
